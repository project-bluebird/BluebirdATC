...
def test_lateral_next_fix_proximity_dist_exp(gym_env: BaseEnv):
    ...
    action = 0
    assert 0.0 <= lateral_next_fix_proximity_dist_exp(gym_env, callsign, action) <= 1.0


def test_lateral_next_fix_proximity_bpfnf(gym_env: BaseEnv):
    ...
    assert lateral_next_fix_proximity_bpfnf(gym_env, callsign, action, next_fix_idx) <= 0.0


def test_lateral_next_fix_proximity_bacnf(gym_env: BaseEnv):
