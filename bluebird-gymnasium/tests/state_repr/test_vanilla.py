...
from bluebird_gymnasium.state_repr.vanilla import VanillaRepresentation, VanillaRepresentationRaw
...
@pytest.mark.parametrize("knn", [0, 2, 4])
def test_vanilla_repr(gym_env: BaseEnv, knn: int):
...
@pytest.mark.parametrize("knn", [0, 2, 4])
def test_vanilla_repr_raw(gym_env: BaseEnv, knn: int):
