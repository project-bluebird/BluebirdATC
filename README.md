 ...
 * `bluebird-dt` [![PyPI version](https://img.shields.io/pypi/v/bluebird-dt?logo=pypi&label=bluebird-dt)](https://pypi.org/project/bluebird-dt/) - the digital twin.  See [here](bluebird-dt/README.md) for more information.
 ...
 * `bluebird-gymnasium` [![PyPI version](https://img.shields.io/pypi/v/bluebird-gymnasium.svg?logo=pypi&label=bluebird-)](https://pypi.org/project/bluebird-gymnasium/) - a gym environment for AI agents.  See [here](bluebird-gymnasium/README.md) for more details. 
